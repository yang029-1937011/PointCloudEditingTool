    ...
    public class KinectManager : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (restartPlayback)
            {
                ...
                Debug.Log(sensorDatas.Count); Debug.Log(sensorInterfaces.Count);
                if (hasStarted)
                {
                    sensorInterfaces.Remove(sensorInterfaces[2]); sensorInterfaces.Remove(sensorInterfaces[1]); sensorInterfaces.Remove(sensorInterfaces[0]);
